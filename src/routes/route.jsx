  ...
  return (
    <Routes>
      <Route element={<Layout />}>
        ...
        {/* Legacy routes: the UGC Job Board and creator enquiry form were retired.
            Keep old links working by redirecting to their replacements. */}
        <Route path="job-board" element={<Navigate to="/careers" replace />} />
        <Route path="jobs/*" element={<Navigate to="/careers" replace />} />
        <Route path="ugc-contact" element={<Navigate to="/contact" replace />} />
